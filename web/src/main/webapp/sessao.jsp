...
<h2> Informações da Sessão: <br> </h2>
ID : <% out.println( session.getId()); %> <br>
Data e hora de criação da sessão :  <% out.println( dt_primeiro_acesso); %> <br>
Data e hora da útlima sessão :  <% out.println( dt_ultimo_acesso); %> <br>
</body>
</html>
